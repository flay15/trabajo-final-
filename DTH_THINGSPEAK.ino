...
// Credenciales Wi-Fi
char ssid[] = "MARGARITAS46";           // Nombre de la red Wi-Fi
char pass[] = "Widaya09";     // Contraseña

// Configuración de ThingSpeak
unsigned long channelID = 2766191;          // ID del canal
const char* WriteAPIKey = "3PD844YKCI0QHKH0"; // API Key de escritura
